    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col items-center justify-center gap-4 lg:flex-row">
        <Card
          ...
          description="I start by understanding your users through interviews, surveys, and data analysis. We'll define the problem, target audience, and success metrics together. This foundation ensures every product decision is user-centric and data-driven."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          description="Based on research insights, I develop a comprehensive product strategy with clear roadmaps, user personas, and success metrics that align with business goals using Agile methodologies. I coordinate with designers, developers, and stakeholders to ensure smooth delivery."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          description="I oversee the entire product development lifecycle, from MVP to launch. Post-launch, I analyze metrics and user feedback to drive continuous improvement."
        >
          <CanvasRevealEffect
            animationSpeed={3}
