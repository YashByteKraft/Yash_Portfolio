  ...
  return (
    <footer id="contact" className="mb-[100px] w-full pb-10 md:mb-auto">
      ...
      <h1 className="heading lg:max-w-[50vw]">
        Ready to transform <span className="text-purple">YOUR</span> ideas into impactful digital products?
        </h1>

        <p className="my-5 text-center text-white-200 md:mt-10">
        From user research to product launch - let&apos;s build something amazing together.
        </p>
      ...
      <div className="relative z-[999] mt-16 flex flex-col items-center justify-between md:flex-row">
        <p className="text-sm font-light md:text-base md:font-normal">
          ...
          <Link
            href="https://yashparihar.netlify.app"
            target="_blank"
            rel="noreferrer noopener"
